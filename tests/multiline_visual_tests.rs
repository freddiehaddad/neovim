...
mod multiline_visual_tests {
    ...
    fn test_user_reported_multiline_bug_scenario() {
        ...
        println!(
            "Line 2 occurrences: {}, Line 3 occurrences: {}",
            line2_count, line3_count
        );

        assert_eq!(
            line2_count, 2,
            "Should have original + pasted 'Line 2: Second line'"
        );
        assert_eq!(
            line3_count, 2,
            "Should have original + pasted 'Line 3: Third line'"
        );
